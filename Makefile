...
install: $(PLUGIN)
	...
	install -Dm644 -t $(DESTDIR)$(DATADIR) assets/sunny.svg assets/night.svg assets/pcloudy.svg assets/npcloudy.svg assets/cloud.svg assets/fog.svg assets/rain.svg assets/pour.svg assets/snow.svg assets/heavy-snow.svg assets/tstorm.svg
